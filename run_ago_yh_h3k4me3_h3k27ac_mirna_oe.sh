...
WORKDIR=$BASEPATH/work_h3k4me3_h3k27ac_mirna_oe
OUTDIR=$BASEPATH/results_h3k4me3_h3k27ac_mirna_oe
DATAPATH=$BASEPATH/data_h3k4me3_h3k27ac_mirna_oe.csv
...
nextflow -log $LOGPATH/${current_datetime}.log \
        run /project/mengjiechen/leizheng/pipeline/cutandrun/main.nf \
        --outdir $OUTDIR \
        -work-dir $WORKDIR \
        --input $DATAPATH \
